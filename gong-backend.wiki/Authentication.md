...
Params: username, email, password, password_confirmation [, phone_number, full_name ]
Success:
{
    "success": true,
...
```sh
Method: facebook
Route: POST http://localhost:3000/auth/facebook
Params: fbId, email [, username, phone_number, full_name, avatar ]
